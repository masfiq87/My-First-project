...
void login()
{
    ...
    char MASFIQ[100]="MASFIQ";
    char project[100]="project";
    do
    {
        system("cls");
        ...
        pword[i]='\0';
        i=0;
        if(strcmp(uname,MASFIQ)==0 && strcmp(pword,project)==0)
        {
...
int main()
{
    ...
    printf("\t\t\t\t\xdb\xdb\xdb      ----------------------------       \xdb\xdb\xdb\n");
    printf("\t\t\t\t\xdb\xdb\xdb       WELCOME TO Resort CODE CAVE        \xdb\xdb\xdb\n");
    printf("\t\t\t\t\xdb\xdb\xdb      ----------------------------       \xdb\xdb\xdb\n");
    printf("\t\t\t\t\xdb\xdb\xdb                                         \xdb\xdb\xdb\n");
    printf("\t\t\t\t\xdb\xdb\xdb                                         \xdb\xdb\xdb\n");
    printf("\t\t\t\t\xdb\xdb\xdb                                         \xdb\xdb\xdb\n");
    printf("\t\t\t\t\xdb\xdb\xdb       ADDRESS   : Mirpur-2,Dhaka        \xdb\xdb\xdb\n");
    printf("\t\t\t\t\xdb\xdb\xdb  CONTACT :Masfiq-+8801972174308         \xdb\xdb\xdb\n");
    printf("\t\t\t\t\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\n");
    for(i=0; i<110; i++)
        printf("-");
...
void add()
{
    ...
    {
        system("cls");
        printf("\xdb \xdb \xdb \xdb \xdb \xdb \xdb \xdb \xdb \xdb \xdb \xdb ENTER CUSTOMER DETAILS \xdb \xdb  \xdb \xdb \xdb \xdb \xdb \xdb \xdb \xdb");
        printf("\n\n");
